...
const Appointment = () => {
  ...
  const [originalAppointment, setOriginalAppointment] = useState(null); // To store original appointment before edit

  // Handle editing an appointment
  const handleEdit = (appointment) => {
    setOriginalAppointment({ ...appointment }); // Save original data for cancel
  ...
  const handleSaveEdit = () => {
    ...
    setOriginalAppointment(null); // Reset original data after saving
  };

  // Handle canceling the edit
  const handleCancelEdit = () => {
    setEditAppointment(null);
    setOriginalAppointment(null); // Reset original data after canceling
  };
  ...
  // Handle input changes for the edited appointment
                ...
                {editAppointment && editAppointment.id === appointment.id ? (
                  ...
                  <>
                    <button
                      ...
                      className="btn w-full bg-green-600 text-white mr-2"
                    >
                      Edit
                    </button>
                    <button
