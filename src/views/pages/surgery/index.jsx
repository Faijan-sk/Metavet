        ...
        <div className="space-y-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              The modern amenities and pristine conditions of our surgical rooms
              enable our staff to function at peak capacity. We ensure that all
              lab work and pre-surgical exams are completed in a timely manner,
              so that your pet can undergo surgery with the best possible
              preparation.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              ...
              and happier life after returning from our facilities. We make sure
              that your pet feels as comfortable as possible during their stay
              with us.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              ...
              constantly monitors and adjusts your pet's temperature, IV fluids,
              and anesthesia. We communicate any potential anomalies that could
              affect the surgery’s outcome to ensure a safe and successful
              procedure.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              ...
              surgery is the best way to ensure the most favorable outcomes for
              your pet. Our staff is fully dedicated to making sure your pet
